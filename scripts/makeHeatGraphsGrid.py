...
results_dir = "results/"
chdir(results_dir)
centered_disc_folders = glob('*centered_grid--flows=20--packets-per-sec=400--x-size=15--y-size=15*')
print centered_disc_folders
c1 = 0
...
Z = median_filter(Z, size=100, mode='constant')
